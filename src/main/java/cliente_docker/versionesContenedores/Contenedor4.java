 ...
 * @author andresuv
 */
public class Contenedor4 implements Comparable<Contenedor4> {
    ...
    public Contenedor4(int contenedor_id, String nombreI, String comando, int tiempoLlegada, int tiempoEstimadoIngresado) {
